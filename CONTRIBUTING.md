...
posted to #xolentum-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Xolentum Project.  
...
The "Xolentum Maintainer Team" is defined in this document as the following users:
- sohamb03
- CyberStacker
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Xolentum code or Xolentum's dependency code or Xolentum's potential/future dependency code or research which successfully implements Xolentum.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Xolentum Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Xolentum Maintainer Team.
